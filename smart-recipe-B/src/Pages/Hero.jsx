...
const Hero = () => {
  return (
    <div className='w-full h-[400px] flex flex-col items-center justify-center gap-6 container mx-auto'>
      <h1 className='text-6xl'>Welcome to <span className='font-medium text-[#DE752E]'>Recipe-Builder</span></h1>
      <div className="upper text-center w-[700px] font-medium">
